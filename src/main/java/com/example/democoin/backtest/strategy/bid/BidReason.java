...
public enum BidReason implements Reason {
    ...
    THREE_NEGATIVE_CANDLE_APPEAR_REPAIR_1("THREE_NEGATIVE_CANDLE_APPEAR_REPAIR_1", "음봉 3개 연속 출현(개션1)"),
    THREE_NEGATIVE_CANDLE_APPEAR_REPAIR_2("THREE_NEGATIVE_CANDLE_APPEAR_REPAIR_2", "음봉 3개 연속 출현(개션2)"),
    THREE_NEGATIVE_CANDLE_APPEAR_REPAIR_2_AND_RSI_OVER_30("THREE_NEGATIVE_CANDLE_APPEAR_REPAIR_2_AND_RSI_OVER_30", "음봉 3개 연속 출현(개션2)"),
