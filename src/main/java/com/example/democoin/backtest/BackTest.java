    ...
    public void start() {
        ...
        while (!over) {
            ...
            List<FiveMinutesCandle> fiveMinutesCandles = fiveMinutesCandleRepository.findFiveMinutesCandlesLimitOffset(
                    LocalDateTime.of(2018, 1, 1, 0, 0, 0), limit, offset);
...
//                log.info("KST {} 캔들 백테스팅 시작", target.getCandleDateTimeKst());
                ...
                if (isAsk) {
                    ...
                    매도(targetCandle, openingPrice, askVolume, askFee, wallet);
                ...
                if (LocalDateTime.of(2018, 2, 1, 0, 0, 0).isBefore(targetCandle.getCandleDateTimeKst())) {
                    return;
                }
            }
            page++;
